# PDF Librarian - App Store Listing Draft
...
PDF Librarian is a macOS app for managing metadata of book and academic paper PDFs. It searches multiple metadata sources from filename/content hints, then lets you review and write Dublin Core fields directly into PDF files.

Key capabilities:
- Multi-source lookup and field merge (Google Books, Open Library, Douban web search, Library of Congress)
- Deduplication and ranking by ISBN/DOI/title+author
...
- Multi-language UI + Daylight/Moonlight appearance modes
